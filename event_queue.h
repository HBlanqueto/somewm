...
enum {
	...
	/* Content signal (per-client, 0 args) - client's main surface committed.
	 * Deferred to the frame boundary; Lua side latches + gates by interval,
	 * so fire-and-forget per-frame commits are cheap to handle. */
	SIG_SURFACE_COMMIT,
